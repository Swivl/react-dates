...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _OutsideClickHandler = __webpack_require__(24);
	...
	var _OrientationShape = __webpack_require__(9);
	...
	var propTypes = {
	  ...
	  timeInput: _propTypes2['default'].element,
	      ...
	      function renderNavigation() {
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            isVertical ? _react2['default'].createElement(_chevronUp2['default'], null) : _react2['default'].createElement(_arrowLeft2['default'], null)
	          ),
	          _react2['default'].createElement(
	            'span',
	            {
	        ...
	        for (var i = 0; i < 7; i++) {
	          header.push(_react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'small',
	              null,
	              (0, _moment2['default'])().weekday(i).format('ddd')
	            )
	          ));
	        }
	    ...
	    value: function () {
	      function render() {
	        ...
	        var _props = this.props,
	            ...
	            onDayTouchStart = _props.onDayTouchStart,
	            onDayTouchEnd = _props.onDayTouchEnd,
	            onDayTouchTap = _props.onDayTouchTap,
	        ...
	        return _react2['default'].createElement(
	          'div',
	          { className: dayPickerClassNames, style: dayPickerStyle },
	          _react2['default'].createElement(
