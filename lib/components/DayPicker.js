...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrowLeft = __webpack_require__(39);

	var _arrowLeft2 = _interopRequireDefault(_arrowLeft);

	var _arrowRight = __webpack_require__(36);
	...
	var _getTransformStyles = __webpack_require__(17);

	var _getTransformStyles2 = _interopRequireDefault(_getTransformStyles);

	var _OrientationShape = __webpack_require__(11);
	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function () {
	      function renderWeekHeader(index) {
	        ...
	        var header = [];
	        for (var i = 0; i < 7; i++) {
	          header.push(_react2['default'].createElement('li', { key: i }, _react2['default'].createElement('small', null, (0, _moment2['default'])().weekday(i).format('ddd'))));
	        }
