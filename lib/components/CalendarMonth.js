...
/***/ (function(module, exports, __webpack_require__) {
	...
	function CalendarMonth(props) {
	  var month = props.month,
	      ...
	      onDayMouseDown = props.onDayMouseDown,
	      onDayMouseUp = props.onDayMouseUp,
	      ...
	      onDayTouchTap = props.onDayTouchTap;
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: calendarMonthClasses, 'data-visible': isVisible },
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        (0, _getCalendarMonthWeeks2['default'])(month, enableOutsideDays).map(function (week, i) {
	          return _react2['default'].createElement(
	            'tr',
	            { key: i },
	            week.map(function (day, j) {
	              ...
	              var className = (0, _classnames2['default'])('CalendarMonth__day', {
	                ...
	                'CalendarMonth__day--current-date': (0, _moment2['default'])(day).isSame(now, 'day')
	              ...
	              return _react2['default'].createElement(
	                ...
	                day && _react2['default'].createElement(_CalendarDay2['default'], {
	                  day: day,
